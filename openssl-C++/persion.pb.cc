...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_persion_2eproto = {
  &descriptor_table_persion_2eproto_initialized, descriptor_table_protodef_persion_2eproto, "persion.proto", 149,
